...
在[这里](https://github.com/EndlessCheng/codeforces-go/blob/master/leetcode/README.md) ***灵茶山艾府*** 一直更新**基础算法精讲**，目前作为算法系统学习的主要部分(周赛分达到一定水平后可进入其算法群)。同步刷新如下：
...
| [最长递增子序列 LIS](https://www.bilibili.com/video/BV1ub411Q7sB/) | [300. 最长递增子序列](https://leetcode.cn/problems/longest-increasing-subsequence/) | [代码](https://leetcode.cn/problems/longest-increasing-subsequence/solution/jiao-ni-yi-bu-bu-si-kao-dpfu-o1-kong-jia-4zma/) | 包括贪心二分 + �(1) 空间 |
...
| 题目                                                         | 类型 |
| ------------------------------------------------------------ | ---- |
| [统计能整除数字的位数](https://leetcode.cn/problems/count-the-digits-that-divide-a-number/) | 数位 |
| [数组乘积中的不同质因数数目](https://leetcode.cn/problems/distinct-prime-factors-of-product-of-array/) | 数学 |
| [将字符串分割成值不超过 K 的子字符串](https://leetcode.cn/problems/partition-string-into-substrings-with-values-at-most-k/) | 贪心 |
| [范围内最接近的两个质数](https://leetcode.cn/problems/closest-prime-numbers-in-range/) | 数学 |
...
| 题目                                                         | 类型              |
| ------------------------------------------------------------ | ----------------- |
| [数组元素和与数字和的绝对差](https://leetcode.cn/problems/difference-between-element-sum-and-digit-sum-of-an-array/) | 数位              |
| [子矩阵元素加 1](https://leetcode.cn/problems/increment-submatrices-by-one/) | 一维差分/二维差分 |
| [统计好子数组的数目](https://leetcode.cn/problems/count-the-number-of-good-subarrays/) | 双指针            |
| [最大价值和与最小价值和的差值](https://leetcode.cn/problems/difference-between-maximum-and-minimum-price-sum/) | 树形DP            |

## B96_2023_01_21_6

| 题目                                                         | 类型   |
| ------------------------------------------------------------ | ------ |
| [最小公共值](https://leetcode.cn/problems/minimum-common-value/) | 双指针 |
| [使数组中所有元素相等的最小操作数 II](https://leetcode.cn/problems/minimum-operations-to-make-array-equal-ii/) | 数组   |
| [最大子序列的分数](https://leetcode.cn/problems/maximum-subsequence-score/) | 最小堆 |
| [判断一个点是否可以到达](https://leetcode.cn/problems/check-if-point-is-reachable/) | GCD    |
...
| 题目                                                         | 类型        |
| ------------------------------------------------------------ | ----------- |
| [分割数组中数字的数位](https://leetcode.cn/problems/separate-the-digits-in-an-array/) | 数位        |
| [从一个范围内选择最多整数 I](https://leetcode.cn/problems/maximum-number-of-integers-to-choose-from-a-range-i/) | 哈希表+贪心 |
| [两个线段获得的最多奖品](https://leetcode.cn/problems/maximize-win-from-two-segments/) | 双指针      |
| [二进制矩阵中翻转最多一次使路径不连通](https://leetcode.cn/problems/disconnect-path-in-a-binary-matrix-by-at-most-one-flip/) | DFS         |

## 331_2023_02_05_10

| 题目                                                         | 类型    |
| ------------------------------------------------------------ | ------- |
| [从数量最多的堆取走礼物](https://leetcode.cn/problems/take-gifts-from-the-richest-pile/) | 最大堆  |
| [统计范围内的元音字符串数](https://leetcode.cn/problems/count-vowel-strings-in-ranges/) | 前缀和  |
| [打家劫舍 IV](https://leetcode.cn/problems/house-robber-iv/) | 二分 DP |
| [重排水果](https://leetcode.cn/problems/rearranging-fruits/) | 贪心    |
...
| 题目                                                         | 类型         |
| ------------------------------------------------------------ | ------------ |
| [左右元素和的差值](https://leetcode.cn/problems/left-and-right-sum-differences/) | 前缀和       |
| [找出字符串的可整除数组](https://leetcode.cn/problems/find-the-divisibility-array-of-a-string/) | 数学         |
| [求出最多标记下标](https://leetcode.cn/problems/find-the-maximum-number-of-marked-indices/) | 双指针 二分  |
| [在网格图中访问一个格子的最少时间](https://leetcode.cn/problems/minimum-time-to-visit-a-cell-in-a-grid/) | 二分答案+BFS |
...
| 题目                                                         | 类型       |
| ------------------------------------------------------------ | ---------- |
| [递枕头](https://leetcode.cn/problems/pass-the-pillow/)      | 数学       |
| [二叉树中的第 K 大层和](https://leetcode.cn/problems/kth-largest-sum-in-a-binary-tree/) | 二叉树 BFS |
| [分割数组使乘积互质](https://leetcode.cn/problems/split-the-array-to-make-coprime-products/) | 数学       |
| [获得分数的方法数](https://leetcode.cn/problems/number-of-ways-to-earn-points/) | 分组背包   |

## 336_2023_03_12_17

| 题目                                                         | 类型          |
| ------------------------------------------------------------ | ------------- |
| [统计范围内的元音字符串数](https://leetcode.cn/problems/count-the-number-of-vowel-strings-in-range/) | 数组          |
| [重排数组以得到最大前缀分数](https://leetcode.cn/problems/rearrange-array-to-maximize-prefix-score/) | 贪心          |
| [统计美丽子数组数目](https://leetcode.cn/problems/count-the-number-of-beautiful-subarrays/) | 前缀和+哈希表 |
| [完成所有任务的最少时间](https://leetcode.cn/problems/minimum-time-to-complete-all-tasks/) | 贪心          |
...
| [美丽子集的数目](https://leetcode.cn/problems/the-number-of-beautiful-subsets/) | DP               |
| [执行操作后的最大 MEX](https://leetcode.cn/problems/smallest-missing-non-negative-integer-after-operations/) | 同余分组         |

## 338_2023_03_26_20

| 题目                                                         | 类型                 |
| ------------------------------------------------------------ | -------------------- |
| [K 件物品的最大和](https://leetcode.cn/problems/k-items-with-the-maximum-sum/) | 数组                 |
| [质数减法运算](https://leetcode.cn/problems/prime-subtraction-operation/) | 二分查找             |
| [使数组元素全部相等的最少操作次数](https://leetcode.cn/problems/minimum-operations-to-make-all-array-elements-equal/) | 排序+前缀和+二分查找 |
| [收集树中金币](https://leetcode.cn/problems/collect-coins-in-a-tree/) | 拓扑排序             |
...
| 题目                                                         | 类型              |
| ------------------------------------------------------------ | ----------------- |
| [最长平衡子字符串](https://leetcode.cn/problems/find-the-longest-balanced-substring-of-a-binary-string/) | 数组              |
| [转换二维数组](https://leetcode.cn/problems/convert-an-array-into-a-2d-array-with-conditions/) | 数组              |
| [老鼠和奶酪](https://leetcode.cn/problems/mice-and-cheese/)  | 贪心              |
| [最少翻转操作数](https://leetcode.cn/problems/minimum-reverse-operations/) | BFS+平衡树/并查集 |

## 340_2023_04_09_23

| 题目                                                         | 类型      |
| ------------------------------------------------------------ | --------- |
| [对角线上的质数](https://leetcode.cn/problems/prime-in-diagonal/) | 数学      |
| [等值距离和](https://leetcode.cn/problems/sum-of-distances/) | 数学      |
| [最小化数对的最大差值](https://leetcode.cn/problems/minimize-the-maximum-difference-of-pairs/) | 贪心      |
| [网格图中最少访问的格子数](https://leetcode.cn/problems/minimum-number-of-visited-cells-in-a-grid/) | 单调栈 DP |

## B102_2023_04_15_24

| 题目                                                         | 类型           |
| ------------------------------------------------------------ | -------------- |
| [查询网格图中每一列的宽度](https://leetcode.cn/problems/find-the-width-of-columns-of-a-grid/) | 数组           |
| [一个数组所有前缀的分数](https://leetcode.cn/problems/find-the-score-of-all-prefixes-of-an-array/) | 数组           |
| [二叉树的堂兄弟节点 II](https://leetcode.cn/problems/cousins-in-binary-tree-ii/) | 二叉树 BFS     |
| [设计可以求最短路径的图类](https://leetcode.cn/problems/design-graph-with-shortest-path-calculator/) | Dijkstra/Floyd |

## 341_2023_04_16_25

| 题目                                                         | 类型 |
| ------------------------------------------------------------ | ---- |
| [一最多的行](https://leetcode.cn/problems/row-with-maximum-ones/) | 数组 |
| [找出可整除性得分最大的整数](https://leetcode.cn/problems/find-the-maximum-divisibility-score/) | 数组 |
| [构造有效字符串的最少插入数](https://leetcode.cn/problems/minimum-additions-to-make-valid-string/) | 数组 |
| [最小化旅行的价格总和](https://leetcode.cn/problems/minimize-the-total-price-of-the-trips/) | DP   |
