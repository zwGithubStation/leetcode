# 题目：<br>
- [正整数与负整数的最大计数 3分](https://leetcode.cn/problems/maximum-count-of-positive-integer-and-negative-integer/)
- [执行 K 次操作后的最大分数 4分](https://leetcode.cn/problems/maximal-score-after-applying-k-operations/)
